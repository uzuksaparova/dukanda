...
import './clientsDeviceInfoChangeModal.scss';
            ...
            >
                <Fade in={isClientDeviceModalOpen}>
                    <Box sx={style}>
                        ...
                        <div className="client-device-change-body">
                            <div className="client-device-change-one-row">
                                <div className="left">
