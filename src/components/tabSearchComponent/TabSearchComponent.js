...
import './tabSearchComponent.scss';
import {
    setIsFilterOpen,
    setIsSortOpen,
...
function TabSearchComponent(props) {
    const {
        searchValue,
        handleInputChange,
        onSearchIconClick,
    ...
    return (
        <div className="tab-search-component">
...
export default connect(mapStateToProps, mapDispatchToProps)(TabSearchComponent);
